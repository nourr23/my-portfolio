...
export const Services = () => {
  ...
  return (
    <div className="border-b border-gray-800 w-full">
      <div className=" md:py-20 py-4 w-full md:px-11 px-2 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))]  from-secondary-500/20 via-dark-300  to-dark-300">
